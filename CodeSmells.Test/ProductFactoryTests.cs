...
namespace CodeSmells.Test
{
    public class ProductFactoryTests
    {
        ...
        {
            var expected = new ProductByItem { ProductName = "Item", Quantity = 2, Price = 3m, PricingMethod = PriceMethodEnum.PerItem};
        ...
        {
            var expected = new ProductByWeight { ProductName = "Item", Weight = 2m, Price = 3m, PricingMethod = PriceMethodEnum.PerPound};
